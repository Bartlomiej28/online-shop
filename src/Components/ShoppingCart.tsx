...
export default function ShoppingCart() {
  ...
  const showShoppingCart = useShoppingCartStore((state)=> state.showShoppingCart);
  ...
  return (
    <Transition show={showShoppingCart}>
                ...
                <DialogPanel className="pointer-events-auto w-screen max-w-md">
                  <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                      ...
                      <div className="mt-8">
                        <div className="flow-root">
                          <ul role="list" className="-my-6 divide-y divide-gray-200">
                            {itemsList.length === 0 ? <p className='w-full text-center pt-10'>Twój koszyk jest pusty</p>: 
                                      ...
                                      <div className="flex flex-1 items-end justify-between text-sm">
                                        ...
                                        <div className="flex">
                                          <button
                                            ...
                                            onClick={()=>{removeFromCart(product.id, product.color, product.size, product.price)}}
                                          >
                                            Usuń
                                          </button>
                                        </div>
                    ...
                    <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                      ...
                      <p className="mt-0.5 text-sm text-gray-500">Dostawa i podatki są wliczone w cenę.</p>
                      <div className="mt-6">
                        <Link
                          href="/checkout"
